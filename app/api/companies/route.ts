...
export async function POST(req: NextRequest) {
  ...
  after(() => logAudit({ accountId, userId: session.user.id, userEmail: session.user.email, action: 'company.created', entityType: 'company', entityId: company.id, entityLabel: company.name, ipAddress: getIp(req) }))
