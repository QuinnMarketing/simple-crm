...
export default function QuoteModal({ initial, prefill, type, leadId, leadEmail, leadName = '', leadService, leadNotes, leadAddress, accountParam, onSave, onDelete, onClose }: QuoteModalProps) {
